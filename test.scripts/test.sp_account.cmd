...
curl -v --header "Content-Type: application/json" --data  "{ \"sp_account_uuid\" : \"97092d99-e101-4438-9fc3-adabdd3c255c\", \"sp_name\":\"Account 1\", \"started_on\":\"1917-08-01 12:15:01\", \"expired_on\":\"2199-12-31 15:12:59\", \"active\": true, \"default_att_level_with_sp_ani\" : \"C\" , \"default_att_level_wo_sp_ani\" : \"C\"}" http://localhost:8080/api/account_create
@echo ..... update
